      ...
      <div className="m-4 row dashboard">
        <div className="row">
          ...
          <div className="col-md-9">
            <h1 className="d-flex justify-content-center align-items-center">Manage Category</h1>
                  ...
                  {categories?.map((c) => (
                    <>
                      <tr>
                        ...
                        <td>
                          <button
                            className="btn btn-primary ms-2 w-auto"
                            onClick={() => {
                              setVisible(true);
                          ...
                          <button
                            className="btn btn-danger ms-2 m-2 w-auto"
                            onClick={() => {
                              handleDelete(c._id);
                            }}
                          >
